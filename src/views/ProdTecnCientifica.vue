...
<v-content class="px-12">
    <p class="content-title-1">Produção Técnica e Científica</p>
    <p class="content-title-2 px-8 pt-2">
        Comunicações e artigos
    </p>
    <v-container fluid class="ma-0 px-12" v-for="item in listaPubs" :key="item.ano">
        <p class="pt-4">
            <u>{{ item.ano }}</u>
        </p>
        <ul class="px-9" v-for="pub in item.pubs" :key="pub.url">
            <li>
                <a :href="pub.url"> {{ pub.titulo }}, </a>
                <br />
                <p>{{ pub.local }}, <br /></p>
        ...
        return {
            listaPubs: [{
                    ...
                    pubs: [{
                        ...
                        {
                            titulo: "Plataforma CLAV: contributo para a disponibilização de dados abertos da Administração Pública em Portugal",
                            url: "https://www.bad.pt/publicacoes/index.php/cadernos/article/view/2047",
                            local: "Cadernos BAD (nº 2), Lisboa",
                            autores: [
                                "Alexandra Lourenço, ",
                                "José Carlos Ramalho, ",
                                "Maria Rita Gago, ",
