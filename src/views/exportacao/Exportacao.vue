        ...
        return {
            ...
            queryStrings: {
                classes: {
                    estrutura: {
                        label: "Estrutura",
                        desc: "Estrutura. Pode ser em árvore ou em lista. A estrutura em arvore é a predefinida.",
                        enum: ["Por definir", "arvore", "lista"],
                        multiple: false
                    },
                    tipo: {
                        label: "Tipo",
                        desc: "Devolve as classes (processos) filtrando pelo tipo de processo (comuns ou especificos).",
                        enum: ["Por definir", "comum", "especifico"],
                        multiple: false
                    },
                    nivel: {
                        label: "Nível",
                        desc: "O nível dos processos devolvidos numa lista. Podem ser de 1º, 2º, 3º e 4º nível.",
                ...
                entidades: {
                    ents: {
                        label: "Entidades",
                        desc: "Devolve a informação destas entidades. Exemplo de input: 'ent_AAN,ent_SEF'",
                        enum: [],
                        multiple: true
                    },
                    processos: {
                        label: "Processos",
                        desc: "No caso de ser escolhido 'com' é listado as entidades com PNs associados. Já no caso de ser escolhido 'sem' é listado as entidades sem PNs associados.",
                        enum: ["Por definir", "com", "sem"],
                        multiple: false
                    },
                    sigla: {
                        label: "Filtrar por sigla",
                        desc: "Permite filtrar as entidades que contém a sigla igual a este valor. (ex: AR)",
                        enum: [],
                        multiple: false
                    },
                    designacao: {
                        label: "Filtrar por designação",
                        desc: "Permite filtrar as entidades que contém a designacao igual a este valor. (ex: Assembleia da República)",
                        enum: [],
                        multiple: false
                    },
                    internacional: {
                        label: "Filtrar pelo campo internacional",
                        desc: "Permite filtrar as entidades que contém internacional igual a este valor.",
                        enum: ["Por definir"],
                        multiple: false
                    },
                    sioe: {
                        label: "Filtrar por SIOE",
                        desc: "Permite filtrar as entidades que contém sioe igual a este valor. (ex: 875780390)",
                        enum: [],
                        multiple: false
                    },
                    estado: {
                    ...
                    info: {
                        ...
                        desc: "Caso o valor desta query string não seja 'completa' devolve apenas parte da informação de cada entidade. Caso o valor seja 'completa' devolve toda a informação de cada entidade.",
                ...
                tipologias: {
                    ...
                    designacao: {
                        label: "Filtrar por designação",
                        desc: "Permite filtrar as tipologias que contém a designacao igual a este valor. (ex: Autoridades Administrativas Civis)",
                        enum: [],
                        multiple: false
                    },
                    estado: {
                        label: "Filtrar por estado",
                        desc: "Filtra as tipologias pelo estado das mesmas. O estado pode ser Ativa, Inativa ou Harmonização.",
                        enum: ["Por definir"],
                        multiple: false
                    },
                    info: {
                        label: "Informação completa?",
                        desc: "Caso o valor desta query string não seja 'completa' devolve apenas parte da informação de cada tipologia. Caso o valor seja 'completa' devolve toda a informação de cada tipologia.",
                        enum: ["Por definir", "completa"],
                        multiple: false
                    },
                    fs: fs,
                ...
                legislacoes: {
                    processos: {
                        label: "Processos",
                        desc: "No caso de ser escolhido 'com' é listado os documentos legislativos com PNs associados. Já no caso de ser escolhido 'sem' é listado os documentos legislativos sem PNs associados. Só funciona caso o parâmetro estado não seja definido.",
                        enum: ["Por definir", "com", "sem"],
                        multiple: false
                    },
                    estado: {
                        label: "Filtrar por estado",
                        desc: "Os documentos legislativos tem dois estados possíveis, Ativo ou Revogado. Este parâmetro sobrepõe os seguintes, ou seja, caso este parâmetro seja definido os restantes são ignorados.",
                        enum: ["Por definir"],
                        multiple: false
                    },
                    fonte: {
                        label: "Filtrar por fonte",
                        desc: "No caso de ser definido lista os documentos legislativos de acordo com a fonte especificada. Só funciona caso os parâmetros estado e processos não sejam definidos.",
                        enum: ["Por definir"],
                        multiple: false
                    },
                    info: {
                        label: "Informação completa?",
                        desc: "Caso o valor desta query string não seja 'completa' devolve apenas parte da informação de cada documento legislativo. Caso o valor seja 'completa' devolve toda a informação de cada documento legislativo.",
                        enum: ["Por definir", "completa"],
                        multiple: false
                    },
                    fs: fs,
                ...
                classe: {
                    tipo: {
                        label: "Tipo",
                        desc: "Caso o valor deste campo seja 'subarvore' é devolvida a subarvore com raiz na classe com id igual ao do campo 'id'",
                ...
                entidade: {
                    info: {
                        label: "Informação completa?",
                        desc: "Caso seja um valor que não 'completa' devolve apenas parte da informação da entidade. Caso o valor seja 'completa' devolve toda a informação da entidade.",
                        enum: ["Por definir", "completa"],
                        multiple: false
                    },
                    fs: fs,
                ...
                tipologia: {
                    info: {
                        label: "Informação completa?",
                        desc: "Caso seja um valor que não 'completa' devolve apenas parte da informação da tipologia. Caso o valor seja 'completa' devolve toda a informação da tipologia.",
                        enum: ["Por definir", "completa"],
                        multiple: false
                    },
                    fs: fs,
                ...
                legislacao: {
                    info: {
                        label: "Informação completa?",
                        desc: "Caso seja um valor que não 'completa' devolve apenas parte da informação do documento legislativo. Caso o valor seja 'completa' devolve toda a informação do documento legislativo.",
                        enum: ["Por definir", "completa"],
                        multiple: false
                    },
                    fs: fs,
                ...
                ontologia: {
                    inferencia: {
                        ...
                        desc: "Caso 'true' devolve todos os triplos incluindo os inferidos. Caso 'false' não inclui os inferidos.",
                        enum: [{
                                text: "Por definir",
                                value: ""
                            },
