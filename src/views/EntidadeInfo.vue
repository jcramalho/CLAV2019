...
<v-content class="px-12">
    ...
    <p class="content-text px-8 py-2">
        Catálogo de entidades públicas que intervêm nos processos
        de negócio (classes de 3º nível da Lista Consolidada).
    ...
    <p class="content-text px-8 py-2">
        Para adicionar entidades, selecione a opção <b>ADICIONAR.
            Deve estar registado na CLAV para aceder a esta funcionalidade.</b>
    </p>
    <p class="content-text px-8 py-2">
        Para editar entidades, selecione a opção <b>EDITAR.
            Deve estar registado na CLAV para aceder a esta funcionalidade.</b>
    </p>
    <v-container fluid style="text-align: center;">
        <v-row justify="center" align="center">
            <v-col cols="12" md="4">
                <v-btn @click="$router.push('/entidades/consultar')" rounded class="white--text" :class="{
                                ...
                                <v-col v-if="entidades.ready">
                                    <v-tooltip top color="info" open-delay="500">
                                        <template v-slot:activator="{ on }">
                                            <v-autocomplete light clearable color="blue darken-3" label="Entidade" :items="entidades.entidades" v-model="dadosEditar" v-on="on" />
                                        </template>
