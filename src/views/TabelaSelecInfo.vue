    ...
    <v-container fluid class="ma-0 px-12">
        <ul class="px-9 pt-3">
            ...
            <li>
                ...
                Documentação técnica de apoio, em
                <a @click="$router.push('/forminstr')">Formulários e instruções para a CLAV</a>. Deve estar registado na CLAV para aceder a esta funcionalidade.
            </li>
        </ul>
    </v-container>
    <p class="content-text px-8 py-2">
