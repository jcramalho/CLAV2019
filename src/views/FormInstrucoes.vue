...
<v-content class="px-12">
    ...
    <v-container fluid class="ma-0 px-12">
        <ul class="px-9">
            ...
            <li>
                <a :href="
              `${publicPath}documentos/Formulario_autos_importacao_classes_series.csv`
            ">
                    Formulário autos importação classes_séries;
                </a>
            </li>
            <li>
                <a :href="
              `${publicPath}documentos/Formulario_autos_importacao_agregacoes_UI.csv`
            ">
                    Formulário autos importação agregações_UI;
                </a>
            </li>
            <li>
