...
<v-content class="px-12">
    ...
    <p class="content-text px-8 py-2">
        ...
        documentação acumulada, e submetê-los à DGLAB para verificação de conformidade.
    </p>
    ...
    <v-container fluid style="text-align: center;">
        <v-row justify="center" align="center">
            <v-col cols="12" md="4">
                <v-btn @click="$router.push('/autosEliminacao/consultar')" rounded class="white--text" :class="{
