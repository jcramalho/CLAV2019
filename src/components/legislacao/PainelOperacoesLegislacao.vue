...
<div>
    <v-row class="align-center pa-3" style="text-align:center;">
        ...
        <v-col>
            <v-btn v-if="this.acao == 'Criação'" @click="criarAlterarLegislacao" color="success darken-1" rounded class="white--text" :class="{
            ...
            <v-btn v-else-if="this.acao == 'Alteração'" @click="criarAlterarLegislacao" color="success darken-1" rounded class="white--text" :class="{
            'px-8': $vuetify.breakpoint.lgAndUp,
            'px-2': $vuetify.breakpoint.mdAndDown
          }" id="botao-verde">
        ...
        <v-col>
            <v-btn @click="eliminarLegislacao" color="red darken-4" rounded class="white--text" :class="{
            'px-8': $vuetify.breakpoint.lgAndUp,
            'px-2': $vuetify.breakpoint.mdAndDown
          }" id="botao-vermelho">
    ...
    <v-dialog v-model="pedidoEliminado" width="50%">
        <v-card>
            ...
            <v-card-actions>
                <v-spacer></v-spacer>
                <v-btn color="success darken-1" rounded dark elevation="0" class="px-4" @click="cancelarCriacaoLegislacao">
                    Confirmo
                </v-btn>
