              ...
              : (props.item.preSelected > 0 ? '#FFECB3' : 'transparent')
                    ...
                    <td>
                        <v-radio-group v-model="props.item.participante" row>
                            ...
                            <v-radio v-for="p in participacao" :key="p.idtermo" :label="p.termo.substring(0,3)" :value="p.termo" @click="selecionaParticipacao(props.item, p.termo)" class="caption"></v-radio>
                        </v-radio-group>
                    </td>
                    <td>
