                ...
                'mx-0': $vuetify.breakpoint.mdAndDown,
                  ...
                  'mt-n12': stepNo > 1,
                    ...
                    'mt-12': stepNo > 1,
                      ...
                      tabelaSelecao.idTipologia.split('_')[1] +
                        ...
                        <v-stepper-content step="1" class="pt-0" :class="{
                  'mx-8': $vuetify.breakpoint.lgAndUp,
                  'mx-0': $vuetify.breakpoint.mdAndDown,
                }">
                            <div v-if="entidadeDGLAB">
                                <v-col>
                                    ...
                                    <v-radio-group v-model="tipoTS" column class="mt-3">
                                        <v-radio label="Criar uma Tabela de Seleção para uma entidade" color="primary" value="entidade"></v-radio>
                                        <v-radio label="Criar uma Tabela de Seleção para uma tipologia" color="primary" value="tipologia"></v-radio>
                                    </v-radio-group>

                                    <div v-if="tipoTS == 'entidade' && entidadesReady">
                                        <v-col>
                                            <div class="info-content py-2 pl-6 pr-3" style="min-height: 50px;">
                                                <v-tooltip top color="info" open-delay="500">
                                                    <template v-slot:activator="{ on }">
                                                        <v-autocomplete :items="entidades" label="Selecione a entidade" item-text="label" return-object v-model="ent" v-on="on" color="blue darken-3" clearable></v-autocomplete>
                                                    </template>
                                        ...
                                        <v-col>
                                            <v-form ref="tipologia" :lazy-validation="false">
                                                <div class="info-content py-2 pl-6 pr-3" style="min-height: 50px;">
                                                    <v-tooltip top color="info" open-delay="500">
                                                        <template v-slot:activator="{ on }">
                                                            <v-autocomplete :items="tipologias" item-text="label" return-object label="Selecione a tipologia" v-model="tipSel" color="blue darken-3" clearable v-on="on" :rules="[
                                    (v) =>
                      ...
                      'ma-0 pa-0': $vuetify.breakpoint.mdAndDown,
                                    ...
                                    <span class="subtitle-2">Pretende:</span>
                                    <v-radio-group v-model="tipoTS" column class="mt-3">
                                        <v-radio label="Criar uma Tabela de Seleção para a minha organização" color="primary" value="utilizador"></v-radio>
                                        <v-radio label="Criar uma Tabela de Seleção para uma tipologia" color="primary" value="tipologia"></v-radio>
                                    </v-radio-group>
                                    <div v-if="tipoTS == 'utilizador'">
                                        <v-btn @click="guardaEntidadeUtilizador" rounded class="white--text mt-5" :class="{
                          'px-6': $vuetify.breakpoint.lgAndUp,
                          'px-2': $vuetify.breakpoint.mdAndDown,
                                        ...
                                        <v-col>
                                            <v-form ref="tipologia" :lazy-validation="false">
                                                <div class="info-content py-2 pl-6 pr-3" style="min-height: 50px;">
                                                    <v-tooltip top color="info" open-delay="500">
                                                        <template v-slot:activator="{ on }">
                                                            <v-autocomplete :items="tipologias" item-text="label" label="Selecione a tipologia" v-model="tipSel" v-on="on" :rules="[
                                    (v) =>
                                      !!v || 'Tem de escolher uma tipologia',
                                  ]" color="blue darken-3" clearable return-object></v-autocomplete>
                                                        </template>
                  ...
                  'mt-n12': stepNo > 1,
                    ...
                    'mt-12': stepNo > 1,
                            ...
                            <span v-if="stepNo > 1" class="mt-1">
                                <v-chip class="my-2 mx-4" id="default-chip" text-color="white">
                                    <unicon class="mr-3" name="ts-icon" width="20" height="20" viewBox="0 0 20.71 23.668" fill="#ffffff" />
                  ...
                  'mx-0': $vuetify.breakpoint.mdAndDown,
                    ...
                    'ma-0 pa-0': $vuetify.breakpoint.mdAndDown,
                                ...
                                <v-form ref="nomeTS" :lazy-validation="false" class="px-4">
                                    ...
                                    <div class="info-content py-2 pl-6 pr-3 mt-2" style="min-height: 50px;">
                                        <v-tooltip top color="info" open-delay="1000">
                                            <template v-slot:activator="{ on }">
                                                <v-text-field v-on="on" class="mt-n3" :rules="[
                              (v) => !!v || 'A designação não pode ser vazia',
                            ]" :placeholder="tabelaSelecao.designacao" v-model="tabelaSelecao.designacao" color="blue darken-3" clearable></v-text-field>
                                            </template>
                            ...
                            <v-btn @click="stepNo = 1" rounded class="white--text mt-5 ml-8" :class="{
                    'px-6': $vuetify.breakpoint.lgAndUp,
                    'px-2': $vuetify.breakpoint.mdAndDown,
                  ...
                  " rounded class="white--text mt-5 ml-4" :class="{
                    ...
                    'px-2': $vuetify.breakpoint.mdAndDown,
                        ...
                        <v-stepper-content step="3">
                            <v-col cols="12" v-if="listaProcessosReady" :class="{
