    ...
    <div v-if="infoReady">
      <v-row>
        <v-col>
          ...
          <v-divider
            class="mt-n1 mx-5"
            style="border: 1px solid rgb(153, 195, 236);"
          ></v-divider>
        </v-col>
      </v-row>
      ...
      >
            ...
            <td style="text-align: center !important;">
              <v-tooltip top color="info" open-delay="500">
                <template v-slot:activator="{ on }">
                  ...
                  >
                    <unicon
                      v-if="props.item.dono || props.item.participante"
        ...
        <template v-slot:no-results>
          <v-alert
            ...
            id="alerta-erro"
            >Não foram encontrados resultados.</v-alert
          >
        </template>
      </v-data-table>
      <v-divider
        class="mt-5 mb-3 mx-5"
        style="border: 1px solid rgb(153, 195, 236);"
      ></v-divider>
