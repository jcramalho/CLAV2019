            ...
            <v-card-text class="panel-body">
                <v-stepper v-model="stepNo" vertical>
                    <v-stepper-step :complete="stepNo > 1" step="1">
                        ...
                        <span v-if="stepNo > 1">
                            <v-chip v-for="(e, i) in entSel" :key="i" class="ma-2" color="indigo darken-4" text-color="white" label>
                ...
                ">Continuar</v-btn>
                    ...
                    <v-row align="center" justify="space-around">
                        ...
                        <v-btn v-if="stepNo > 2" dark color="red darken-4" @click="eliminarTabela = true">Cancelar
