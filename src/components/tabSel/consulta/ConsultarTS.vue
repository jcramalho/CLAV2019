    ...
    <v-card class="ma-4">
        ...
        <v-card-text class="ma-1">
            ...
            <v-row>
                ...
                <v-col xs="3" sm="3" />
                <v-col xs="5" sm="5">
                    <v-text-field label="Procurar" v-model="search" append-icon="search" single-line hide-details />
                </v-col>
            </v-row>
            <v-row>
                <v-col>
                    <v-data-table :headers="headers" :items="ts.classes" item-key="codigo" :search="search" class="elevation-1" :footer-props="footer_props" :page.sync="paginaTabela" :expanded="expanded" :single-expand="true" @click:row="clicked">
                                                ...
                                                <v-expansion-panel-content>
                                                    <v-row>
                                                        ...
                                                        <v-col xs="10" sm="10">
                                                            ...
                                                            <div class="info-content" v-else-if="item.status == 'H'">Em revisão...</div>
                                                    ...
                                                    <ExemplosNotasAp :exemplos="item.exemplosNotasAp" v-if="item.exemplosNotasAp.length > 0" />

                                                    <NotasEx :notas="item.notasEx" v-if="item.notasEx.length > 0" />

                                                    <TermosIndice :termos="item.termosInd" v-if="item.termosInd.length > 0" />
                                                </v-expansion-panel-content>
                                            </v-expansion-panel>
                                                ...
                                                <v-expansion-panel-content>
                                                    <v-row>
                                                        ...
                                                        <v-col xs="2" sm="2">
                                                            <div class="info-label">
                                                                Tipo de Processo
                                                                <InfoBox header="Tipo de Processo" :text="myhelp.Classe.Campos.TipoProcesso" helpColor="indigo darken-4" />
                                                            </div>
                                                        </v-col>
                                                        <v-col xs="10" sm="10">
                                                    ...
                                                    <v-row>
                                                        ...
                                                        <v-col xs="2" sm="2">
                                                            <div class="info-label">
                                                                ...
                                                                <InfoBox header="Processo Transversal" :text="myhelp.Classe.Campos.ProcessoTransversal" helpColor="indigo darken-4" />
                                                            </div>
                                                        </v-col>
                                                        <v-col xs="10" sm="10">
                                                            <div class="info-content">{{ item.procTrans == "S" ? "Sim" : "Não" }}</div>
                                                        </v-col>
                                                    </v-row>

                                                    <Donos :entidades="item.donos" v-if="item.donos.length > 0" />

                                                    <Participantes :entidades="item.participantes" v-if="item.participantes.length > 0" />

                                                    <ProcessosRelacionados :processos="item.processosRelacionados" v-if="item.processosRelacionados.length > 0" />
                ...
                ">
                                                ...
                                                <v-expansion-panel-content>
                                                    <v-row>
                                                        <v-col xs="12" sm="12">
                                                            <v-toolbar color="indigo darken-4" class="caption font-weight-regular" dark height="25">
                                                    ...
                                                    <v-row>
                                                        ...
                                                        <v-col xs="2" sm="2">
                                                            <div class="info-label">
                                                                Prazo
                                                                <InfoBox header="Prazo" :text="myhelp.Classe.Campos.Prazo" helpColor="indigo darken-4" />
                                                            </div>
                                                        </v-col>
                                                        <v-col xs="10" sm="10">
                                                            <div class="info-content" v-if="item.pca.valores > 1">{{ item.pca.valores + " anos" }}</div>
                                                            <div class="info-content" v-else-if="item.pca.valores == 1">{{ item.pca.valores + " ano" }}</div>
                                                            <div class="info-content" v-else-if="item.pca.notas != ''">Não especificado</div>
                                                        </v-col>
                                                    </v-row>
                                                    ...
                                                    <v-row v-if="item.pca.notas != ''">
                                                        ...
                                                        <v-col xs="2" sm="2">
                                                            <div class="info-label">
                                                                Notas
                                                                <InfoBox header="Notas ao PCA" :text="myhelp.Classe.Campos.Notas" helpColor="indigo darken-4" />
                                                            </div>
                                                        </v-col>
                                                        <v-col xs="10" sm="10">
                                                    ...
                                                    <v-row v-if="item.pca.formaContagem">
                                                        ...
                                                        <v-col xs="2" sm="2">
                                                            <div class="info-label">
                                                                Forma de Contagem
                                                                <InfoBox header="Forma de Contagem" :text="myhelp.Classe.Campos.FormaContagem" helpColor="indigo darken-4" />
                                                            </div>
                                                        </v-col>
                                                        <v-col xs="10" sm="10">
                                                    ...
                                                    <v-row v-if="item.pca.subFormaContagem">
                                                        ...
                                                        <v-col xs="2" sm="2">
                                                            <div class="info-label">
                                                                Subforma de Contagem
                                                                <InfoBox header="Subforma de Contagem" :text="myhelp.Classe.Campos.SubformaContagem" />
                                                            </div>
                                                        </v-col>
                                                        <v-col xs="10" sm="10">
                                                    ...
                                                    <v-row v-if="item.pca.justificacao">
                                                        ...
                                                        <v-col xs="2" sm="2">
                                                            <div class="info-label">
                                                                Justificação
                                                                <InfoBox header="Justificação do PCA" :text="myhelp.Classe.Campos.JustificacaoPCA" helpColor="indigo darken-4" />
                                                            </div>
                                                        </v-col>
                                                        <v-col xs="10" sm="10">
                                                            <div class="info-content">
                            ...
                            ">
                                                    ...
                                                    <v-row>
                                                        ...
                                                        <v-col xs="2" sm="2">
                                                            <div class="info-label">
                                                                Destino Final
                                                                <InfoBox header="Destino Final" :text="myhelp.Classe.Campos.DF" helpColor="indigo darken-4" />
                                                            </div>
                                                        </v-col>
                                                        <v-col xs="10" sm="10">
                                                            <div class="info-content">
                                                    ...
                                                    <v-row v-if="item.df.nota">
                                                        ...
                                                        <v-col xs="2" sm="2">
                                                            <div class="info-label">
                                                                Nota
                                                                <InfoBox header="Nota ao DF" :text="myhelp.Classe.Campos.NotasDF" helpColor="indigo darken-4" />
                                                            </div>
                                                        </v-col>
                                                        <v-col xs="10" sm="10">
                                                    ...
                                                    <v-row v-if="item.df.justificacao">
                                                        ...
                                                        <v-col xs="2" sm="2">
                                                            <div class="info-label">
                                                                Justificação
                                                                <InfoBox header="Justificação do DF" :text="myhelp.Classe.Campos.JustificacaoDF" helpColor="indigo darken-4" />
                                                            </div>
                                                        </v-col>
                                                        <v-col xs="10" sm="10">
                                                            <div class="info-content">
