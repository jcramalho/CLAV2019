        ...
        <v-card-text>
            ...
            <v-form ref="formUI" :lazy-validation="false">
                <v-row>
                    ...
                    <v-col sm="3" md="3">
                        <v-text-field :rules="[v => !!v || 'Campo de preenchimento obrigatório!']" solo clearable v-model="UI_clone.titulo" label="Título"></v-text-field>
                    </v-col>
                </v-row>
                <v-row>
                    <v-col md="2" sm="2">
                ...
                <v-row>
                    ...
                    <v-col xs="12" sm="3">
                        <SelecionarData label="Data Inicial" :d="UI_clone.dataInicial" @dataSelecionada="UI_clone.dataInicial = $event" :dataMinima="RE.dataInicial" :dataMaxima="RE.dataFinal">
                ...
                <v-row>
                    ...
                    <v-col md="9" sm="9">
                        ...
                        <v-data-table :headers="headers" :items="UI_clone.classesAssociadas" hide-default-footer v-if="!!UI_clone.classesAssociadas[0]">
                          ...
                          'Campo obrigatório para associar série/subsérie!'
                            ...
                            <v-row>
                                <v-col cols="12" class="text-right">
                                    <v-btn @click="adicionarClasseUI(UI_clone)" color="green lighten-1" style="margin-left: 10px" dark>Clique para associar série/subsérie à unidade de instalação</v-btn>
