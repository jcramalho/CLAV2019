        ...
        <v-card-text>
            ...
            <v-form ref="form" :lazy-validation="false">
                ...
                <v-row>
                    ...
                    <v-col sm="9" md="9">
                        <v-autocomplete v-model="serie.eFilhoDe" :items="classesHierarquia" :rules="[v => !!v || 'Campo obrigatório!']" item-value="codigo" item-text="searchField" solo clearable placeholder="Classe Pai" chips>
                ...
                <v-expansion-panels v-model="panels" accordion :multiple="isMultiple">
                    ...
                    <v-expansion-panel class="ma-1" popout focusable>
                        ...
                        <v-expansion-panel-content>
                            <ZonaContexto :newSerie="serie" :classes="classes" :legislacao="legislacao" :RE="RE" :legislacaoProcessada="legislacaoProcessada" :formaContagem="formaContagem" :editar="true" :tipos="tipos" />
                        </v-expansion-panel-content>
                    </v-expansion-panel>
                    <v-expansion-panel class="ma-1" popout focusable v-if="!!!treeview_object.children[0]">
                        ...
                        <v-expansion-panel-content>
                            <ZonaDecisoesAvaliacao :rules="true" :newSerie="serie" :classes="classes" :formaContagem="formaContagem" />
                        </v-expansion-panel-content>
                    </v-expansion-panel>
                </v-expansion-panels>
            </v-form>
