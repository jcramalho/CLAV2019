<template>
<div>
    <v-data-table flat :headers="headers" :items="classes" class="elevation-1 mytable" :footer-props="footer_props" @click:row="consultaClasse" :search="search" :items-per-page="5" item-key="codigo">
