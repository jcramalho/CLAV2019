    ...
    <v-card-text>
        ...
        <v-stepper v-model="e1" vertical class="elevation-0" style="background-color:#fafafa">
            ...
            <v-stepper-content step="2">
                <RelatorioExpositivo @seguinte="changeE1" :RE="RADA.RE" :UIs="RADA.tsRada.UIs" @guardar="guardarTrabalho" :classes="RADA.tsRada.classes" :entidades="entidades" :entidadesProcessadas="entidadesProcessadas" :tipologias="tipologias" />
            </v-stepper-content>
            ...
            <v-stepper-content step="3">
                <TSRada @done="concluir(obj._id)" @voltar="changeE1" :legislacao="legislacao" :RE="RADA.RE" :TS="RADA.tsRada" :entidades="entidades" :legislacaoProcessada="legislacaoProcessada" :loading_circle.sync="loading_circle_ts" :pode_remover="true" @guardar="guardarTrabalho" @remover="toDelete = true" @validar="validarRADA" />
