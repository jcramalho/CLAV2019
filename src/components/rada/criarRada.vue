            ...
            <v-stepper-content step="3">
              ...
              >
                <div v-if="!!erros_em_falta[0]">
                  <b
                    >Os seguintes constituintes do RADA estão incompletos ou por
                    preencher:</b
                  >
                  <ul>
                    <li v-for="(em_falta, i) in erros_em_falta" :key="i">
                      {{ em_falta }}
                    </li>
                  </ul>
                  <br />
                ...
                <div v-if="!!erros_datas_uis[0]">
                  <b
                    >As seguintes associações entre classes e unidades de
                    instalação são inválidas devido às datas:</b
                  >
                  <ul>
                ...
                <div v-if="!existe_serie">
                  <b
                    ...
                    possibilidade de associar unidades de instalação às séries
                    em avaliação.</b
                  >
                </div>
              </v-alert>
