...
<div>
    ...
    <v-row v-if="TS.UIs[0]">
        <v-col cols="12" xs="12" sm="12">
            ...
            <v-data-table style="background-color:#fafafa" :headers="headers" :items="filtrar_uis" :footer-props="footer_props" :items-per-page="5">
              ...
              " @click="editarUI(props.item)">
                        <td @click.stop>
                            <v-tooltip top>
                                ...
                                <span>Criar nova UI baseada nos campos de
    ...
    <UI :UIs="TS.UIs" :RE="RE" :classes="TS.classes" v-if="criar_nova_ui" :dialog="criar_nova_ui" @fecharDialog="criar_nova_ui = false" @limpar_copia="UI_para_copiar = null" :UI_para_copiar="UI_para_copiar" />
    <EditaUI v-if="dialog_editar_UI" :dialog="dialog_editar_UI" @fecharDialog="dialog_editar_UI = false" @remover="remover_UI" @atualizar="atualizarUI" :UI_clone="UI_clone" :RE="RE" :classes="TS.classes" />
    <ImportarUIs v-if="importar_uis" :dialog="importar_uis" @fecharDialog="importar_uis = false" @pendurarNovasUIs="mergeUIs" :classes="TS.classes" :RE="RE" :UIs="TS.UIs" />
</div>
</template>
