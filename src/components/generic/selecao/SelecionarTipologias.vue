<template>
    <v-layout row wrap>
        <v-flex xs2>
            <v-subheader class="info-label" style="border-color: white; border-style:solid; color: #1A237E;">Selecionar Tipologias de Entidade:</v-subheader>
        </v-flex>
        <v-flex xs9 v-if="tipologiasReady">
            <v-card>
                <v-card-title>
                    <v-text-field v-model="searchTipologias"
                        append-icon="search"
