        ...
        <v-col class="py-0 my-0">
            ...
            <v-card flat style="border-radius: 10px !important;">
                    ...
                    <v-row>
                        ...
                        <v-col cols="12" lg="10">
                            <div class="info-content pt-3 pb-5 px-5" style="min-height: 50px;">
                                <v-text-field class="mt-n3 px-3" text hide-details single-line clearable label="Nome da Tipologia" color="blue darken-3" maxlength="50" v-model="tipologia.designacao"></v-text-field>
                            </div>
                        </v-col>
                    </v-row>
                ...
                'mt-4': $vuetify.breakpoint.mdAndUp
                        ...
                        <v-col cols="12" lg="10">
                            <div class="info-content pt-3 pb-5 px-5" style="min-height: 50px;">
                                <v-text-field class="mt-n3 px-3" text hide-details single-line clearable label="Sigla" color="blue darken-3" maxlength="10" v-model="tipologia.sigla"></v-text-field>
                            </div>
                        </v-col>
                    </v-row>
                    ...
                    'text-left': $vuetify.breakpoint.mdAndUp
                      ...
                      'px-3': $vuetify.breakpoint.mdAndUp
                                    ...
                                    <unicon class="mt-3" name="entidade-icon" width="20" height="20" viewBox="0 0 20.711 21.105" fill="#ffffff" />
                                    <span class="ml-3 mr-1">Entidades</span>
                                </div>
                            </v-expansion-panel-header>
                            <v-expansion-panel-content id="expanded-content">
                                <DesSelEnt :entidades="entSel" tipo="tipologias" @unselectEntidade="unselectEntidade($event)" />
