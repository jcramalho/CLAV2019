...
<div>
    <v-row class="align-center pa-3" style="text-align:center;">
        ...
        <v-col>
            <v-btn v-if="this.acao == 'Criação'" @click="criarAlterarTipologia" color="success darken-1" rounded class="white--text" :class="{
            ...
            <v-btn v-else-if="this.acao == 'Alteração'" @click="criarAlterarTipologia" color="success darken-1" rounded class="white--text" :class="{
            'px-8': $vuetify.breakpoint.lgAndUp,
            'px-2': $vuetify.breakpoint.mdAndDown
          }" id="botao-verde">
        ...
        <v-col>
            <v-btn @click="eliminarTipologia" color="red darken-4" rounded class="white--text" :class="{
            'px-8': $vuetify.breakpoint.lgAndUp,
            'px-2': $vuetify.breakpoint.mdAndDown
          }" id="botao-vermelho">
    ...
    <v-row justify-center>
        <v-dialog v-model="dialogTipologiaCriada" persistent max-width="60%">
            <DialogTipologiaSucesso :t="t" :codigoPedido="codigoPedido" :acao="acao" />
        </v-dialog>
    </v-row>
    ...
    <v-row justify-center>
        <v-dialog v-model="pedidoEliminado" persistent max-width="60%">
            <v-card dark class="info-card">
                ...
                <v-card-actions>
                    <v-spacer></v-spacer>
                    <v-btn color="success darken-1" rounded dark elevation="0" class="px-4" @click="cancelarCriacaoTipologia">
                        Confirmo
                    </v-btn>
