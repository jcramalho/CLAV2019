                    ...
                    <v-row class="pa-4">
                        ...
                        <v-col cols="12" lg="10">
                            <div class="info-content pt-3 pb-5 px-5" style="min-height: 50px;">
                                <v-text-field class="mt-n3 px-3" text hide-details single-line clearable color="blue darken-3" maxlength="50" v-model="tipologia.designacao" label="Nome da Tipologia"></v-text-field>
                            </div>
                        </v-col>
                    </v-row>
