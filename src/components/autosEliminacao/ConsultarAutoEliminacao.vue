                                ...
                                <template v-slot:activator>
                                    <v-list-item-content class="info-label">
                                        <v-list-item-title class="mx-2">
                                            <div v-if="item.codigo && item.referencia">
                                                {{
                            item.codigo +
                              ": " +
                              item.referencia +
                              ...
                              item.titulo
                                ...
                                (d.dono || "").split("_")[1] + " - " + d.nome
                                        ...
                                        <div class="ma-1" v-if="item.agregacoes && item.agregacoes.length > 0">
                                            ...
                                            <v-data-table :headers="cabecalho" :items="item.agregacoes" :items-per-page="5" class="elevation-1 ml-2 mt-3" :footer-props="footer_props" :search="search" />
                                        </div>
                                    </v-list-item-title>
                                </v-list-item-content>
                            </v-list-group>
