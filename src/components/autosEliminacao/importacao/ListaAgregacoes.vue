<template>
<v-data-table :headers="(tipo=='TS_LC' || tipo=='PGD_LC') ? cabecalhoLC : cabecalho" :items="agregacoes" :items-per-page="5" class="elevation-1 ml-2 mt-3" :footer-props="footer_props" :search="search">
        ...
        <tr>
            ...
            <td style="text-align: center;" v-if="(tipo=='TS_LC' || tipo=='PGD_LC') && (df==='C' || df==='Conservação') && prop.item.ni!=='Participante'">
                <v-tooltip bottom>
                    ...
                    <span>Alterado em confomidade com <strong>Destino Final</strong> de
