...
<div>
        ...
        <v-card-text class="panel-body">
            ...
            <v-stepper v-model="steps" vertical>
                    ...
                    <v-row>
                        <v-col :md="3">
                            <div class="info-label">
                                ...
                                <InfoBox header="Fonte de Legitimação" :text="myhelp.AutoEliminacao.Campos.FonteLegitimacao" helpColor="indigo darken-4" dialogColor="#E0F2F1" />
                            </div>
                        </v-col>
                        <v-col>
              ...
              " :disabled="!auto.legislacao || auto.fundo.length == 0">Continuar</v-btn>
                ...
                steps = 1;
                cleanFiles();
              " color="indigo darken-4" dark class="ma-2">Voltar</v-btn>
                ...
                <v-stepper-step step="3">Validação de classes / séries e agregações / unidades de
    ...
    <v-dialog v-model="erroDialog" width="700" persistent>
        <v-card outlined>
            <v-card-title class="red darken-4 title white--text" dark>Erro no pedido de importação de auto de eliminação</v-card-title>
