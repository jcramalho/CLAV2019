      ...
      <v-card-text class="panel-body">
        ...
        <v-stepper v-model="steps" vertical>
          ...
          <v-stepper-content step="2">
            ...
            <v-btn @click="steps = 1" color="indigo darken-4" dark class="ma-2"
              >Voltar</v-btn
            >
            <v-btn
              class="ma-2"
          ...
          <v-stepper-step step="3"
            >Validação de Séries / Agregações</v-stepper-step
          >
          ...
          <v-stepper-content step="3">
            <ValidarAE
              ...
              :tipo="tipo"
            />
            <v-btn @click="steps = 2" color="indigo darken-4" dark class="ma-2"
              >Voltar</v-btn
            >
            <v-btn
              medium
  ...
  methods: {
    validar: async function() {
      for (var zc of this.auto.zonaControlo) {
        if (
          this.tipo == "RADA" &&
          (!zc.prazo || zc.prazo == "" || !/^[0-9]*$/.test(zc.prazo))
        ) {
          this.errosVal.erros.push({
            sobre: "Prazo de Conservação Administrativa",
            mensagem:
              "Preenchimento incorreto ou não preenchido na classe " +
              zc.codigo +
              " " +
              zc.referencia
          });
