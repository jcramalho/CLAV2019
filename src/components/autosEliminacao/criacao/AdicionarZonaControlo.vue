...
<div>
    ...
    <v-dialog v-model="addZC">
        <DialogZonaControlo v-bind:auto="auto" v-bind:classes="classes" v-bind:entidades="entidades" v-bind:closeZC="closeZC" v-bind:classesCompletas="classesCompletas" v-bind:donos="donos" v-bind:tipo="tipo" />
    </v-dialog>
    ...
    <v-dialog v-model="erroDialog" width="700" persistent>
        <v-card outlined>
            <v-card-title class="red darken-4 title white--text" dark>Não foi possível importar o ficheiro de agregações</v-card-title>
    ...
    <v-dialog v-model="sucessDialog" width="700" persistent>
        <v-card outlined>
            <v-card-title class="teal darken-4 title white--text" dark>Foi possível importar do ficheiro de agregações</v-card-title>
