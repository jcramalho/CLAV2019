...
<div>
    <v-list shaped>
        <v-list-group v-for="(item, index) in auto.zonaControlo" :key="index" color="grey darken-1">
            ...
            <v-list-item-content>
                <v-list-item-title class="mx-2">
                    ...
                    <v-row v-if="item.prazoConservacao">
                        ...
                        <v-col>
                            <v-card class="mt-2" style="color: #757575" elevation="0">
                    ...
                    <v-row v-if="item.notasPCA">
                        ...
                        <v-col>
                            <v-card class="mt-2" style="color: #757575" elevation="0">{{ item.notasPCA }}</v-card>
                        </v-col>
                    </v-row>
                    <v-row v-if="item.destino">
                        ...
                        <v-col v-if="item.destino === 'E'">
                            <v-card class="mt-2" style="color: #757575" elevation="0">Eliminação</v-card>
                        </v-col>
                        <v-col v-else-if="item.destino === 'C'">
                            <v-card class="mt-2" style="color: #757575" elevation="0">Conservação</v-card>
                        </v-col>
                        <v-col v-else>
                            <v-card class="mt-2" style="color: #757575" elevation="0">{{ item.destino }}</v-card>
                        </v-col>
                    </v-row>
                    <v-row v-if="item.ni  && item.df!='Eliminação' && tipo!='RADA' && tipo!='PGD'">
                        ...
                        <v-col>
                            <v-card class="mt-2" style="color: #757575" elevation="0">{{ item.ni }}</v-card>
                        </v-col>
                    </v-row>
                    <v-row v-if="item.destino === 'C' && tipo!='RADA' && tipo!='PGD'">
                        <v-col cols="3">
                            <v-card class="info-label" style="color: #1a237e; background-color: #dee2f8;" elevation="0">Dono do PN <v-icon color="red" v-if="item.dono.length==0">warning</v-icon>
                            </v-card>
                        </v-col>
                        <v-col>
                            <v-card class="mt-2" style="color: #757575" elevation="0">
                    ...
                    <v-row v-if="item.notaDF">
                        ...
                        <v-col>
                            <v-card class="mt-2" style="color: #757575" elevation="0">{{ item.notaDF }}</v-card>
                        </v-col>
                    </v-row>
                    <v-row>
                        <v-col cols="3">
                        ...
                        <v-col>
                            <v-card class="mt-2" style="color: #757575" elevation="0">{{ item.dataInicio }}</v-card>
                        </v-col>
                    </v-row>
                    <v-row>
                        <v-col cols="3">
                        ...
                        <v-col>
                            <v-card class="mt-2" style="color: #757575" elevation="0">{{ item.dataFim }}</v-card>
                        </v-col>
                    </v-row>
                    <v-row>
                        <v-col cols="3">
                    ...
                    <v-row v-if="item.uiPapel">
                        ...
                        <v-col>
                            <v-card class="mt-2" style="color: #757575" elevation="0">{{ item.uiPapel }}</v-card>
                        </v-col>
                    </v-row>
                    <v-row v-if="item.uiDigital">
                        ...
                        <v-col>
                            <v-card class="mt-2" style="color: #757575" elevation="0">{{ item.uiDigital }}</v-card>
                        </v-col>
                    </v-row>
                    <v-row v-if="item.uiOutros">
                        ...
                        <v-col>
                            <v-card class="mt-2" style="color: #757575" elevation="0">{{ item.uiOutros }}</v-card>
                        </v-col>
                    </v-row>
                    <!-- Lista de Agregacoes -->
            ...
            <v-dialog v-model="editarZC">
                <DialogZonaControlo v-bind:auto="auto" v-bind:classes="classes" v-bind:entidades="entidades" v-bind:closeZC="closeZC" v-bind:zona="auto.zonaControlo[editarIndex]" v-bind:index="editarIndex" v-bind:classesCompletas="classesCompletas" v-bind:donos="donos" v-bind:tipo="tipo" />
            </v-dialog>
            <v-dialog v-model="deleteDialog" width="700" persistent>
                <v-card outlined>
                    <v-card-title class="red darken-4 title white--text" dark>Eliminação de Classe</v-card-title>

                    <v-card-text>
                        <div v-if="ag > 0" class="subtitle-1" style="white-space: pre-wrap">
    ...
    <v-dialog v-model="erroDialog" width="700" persistent>
        <v-card outlined>
            <v-card-title class="red darken-4 title white--text" dark>Erro: Não foi possível adicionar a Classe</v-card-title>
