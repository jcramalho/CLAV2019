      ...
      <v-flex xs12 sm20>
        <v-card class="panel panel-default panel-custom">
          ...
          <v-card-text class="panel-body">
            <div class="ma-3">
              ...
              através da importação de ficheiros. Para tal são disponibilizados
              dois tipos de formulários que devem ser preenchidos previamente
              offline:

              <li>
                Um formulário para as séries (veja
                <a
                  :href="`${publicPath}documentos/FormularioAE_SERIE.csv`"
                  download
                  >aqui</a
                >)
              </li>
              <li>
                um formulário para as agregações simples / unidades de
                instalação (veja
                <a
                  :href="`${publicPath}documentos/FormularioAE_UI.csv`"
                  download
                  >aqui</a
                >)
              </li>
              ...
              >
                <tr>
                  ...
                  <td style="width:40%">
                    ...
                    <div style="width:100%">
                      Para submeter um auto de eliminação, selecione os
                      ficheiros que preencheu e guardou previamente.
                    </div>
                    <div>
        ...
        <div style="text-align:center">
          <v-btn
            ...
            @click="submit"
            :disabled="
              !fileSerie || !fileAgreg || !auto.fundo || !auto.legislacao
            "
            class="ma-2"
          >
