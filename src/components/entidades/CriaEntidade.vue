        ...
        <v-col class="py-0 my-0">
            ...
            <v-card flat style="border-radius: 10px !important;">
                    ...
                    <v-row>
                        ...
                        <v-col cols="12" lg="10">
                            <div class="info-content pt-3 pb-5 px-5" style="min-height: 50px;">
                                <v-text-field class="mt-n3 px-3" text hide-details single-line clearable label="Nome da Entidade" color="blue darken-3" maxlength="150" v-model="entidade.designacao"></v-text-field>
                            </div>
                        </v-col>
                    </v-row>
                ...
                'mt-4': $vuetify.breakpoint.mdAndUp
                        ...
                        <v-col cols="12" lg="10">
                            <div class="info-content pt-3 pb-5 px-5" style="min-height: 50px;">
                                <v-text-field class="mt-n3 px-3" text hide-details single-line clearable label="Sigla" color="blue darken-3" maxlength="10" v-model="entidade.sigla"></v-text-field>
                            </div>
                        </v-col>
                    </v-row>
                    <v-row :class="{
