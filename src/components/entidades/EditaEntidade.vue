    ...
    <v-row>
        ...
        <v-col class="py-0 my-0">
            ...
            <v-card flat style="border-radius: 10px !important;">
                ...
                <p class="content-title-2 pb-5" style="color: #4da0d0 !important; text-align: center;">
                  ...
                  acao
                        ...
                        <v-stepper-items>
                            <v-stepper-content step="1" style="text-align: center !important;" class="px-12">
                                <v-radio-group v-model="acao" row class="ml-1 px-6">
                                    ...
                                    <v-radio class="mx-auto" label="Extinguir" value="Extinção"></v-radio>
                                </v-radio-group>
                      ...
                      'px-2': $vuetify.breakpoint.mdAndDown
                                    ...
                                    <v-row>
                                        ...
                                        <v-col cols="12" lg="10">
                                            <div class="info-content pt-3 pb-5 px-5" style="min-height: 50px;">
                                                <v-text-field class="mt-n3 px-3" text hide-details single-line clearable label="Nome da Entidade" color="blue darken-3" v-model="entidade.designacao" />
                                            </div>
                                        </v-col>
                                    </v-row>
                        ...
                        'mt-4': $vuetify.breakpoint.mdAndUp
                                        ...
                                        <v-col cols="12" lg="10">
                                            <div class="info-content pa-5" style="min-height: 50px;">
                                                <v-select class="mt-n5 px-3" v-model="entidade.internacional" :items="['Sim', 'Não']" label="Selecione uma opção" color="blue darken-3" clearable hide-details single-line />
                                            </div>
                                        </v-col>
                                    </v-row>
                                    <v-row :class="{
                        ...
                        'mt-4': $vuetify.breakpoint.mdAndUp
                                        ...
                                        <v-col cols="12" lg="10">
                                            <div class="info-content pt-3 pb-2 px-5" style="min-height: 50px;">
                                                <v-text-field class="mt-n3 px-3" text clearable single-line label="SIOE" color="blue darken-3" v-model="entidade.sioe" :rules="regraSIOE"></v-text-field>
                                            </div>
                                        </v-col>
                                    </v-row>
                        ...
                        'mt-4': $vuetify.breakpoint.mdAndUp
                                        ...
                                        <v-col cols="12" lg="10">
                                            <div class="info-content px-8 pb-2 mt-n1" style="min-height: 50px; padding-top: 0 !important;">
                                                <SelecionarData :d="entidade.dataCriacao" :label="'Data: AAAA-MM-DD'" @dataSelecionada="entidade.dataCriacao = $event" />
                                            </div>
                                        </v-col>
                                    </v-row>
                            ...
                            'text-left': $vuetify.breakpoint.mdAndUp
                              ...
                              'px-3': $vuetify.breakpoint.mdAndUp
                                                    ...
                                                    <unicon class="mt-3" name="tipologia-ent-icon" width="22" height="22" viewBox="0 0 20.711 22.48" fill="#ffffff" />
                                                    <span class="ml-3 mr-1">Tipologias de Entidade</span>
                                                </div>
                                            ...
                                            <v-expansion-panel-content id="expanded-content">
                                                ...
                                                <SelTip :tipologiasReady="tipologiasReady" :tipologias="tipologias" @selectTipologia="selectTipologia($event)" />
                                ...
                                <div v-else>
                                    <v-row>
                                        ...
                                        <v-col cols="12" lg="10">
                                            <div class="info-content px-8 pb-2 mt-n1" style="min-height: 50px; padding-top: 0 !important;">
                                                <SelecionarData :d="entidade.dataExtincao" :label="'Data: AAAA-MM-DD'" @dataSelecionada="entidade.dataExtincao = $event" />
                                            </div>
                                        </v-col>
                                    </v-row>
                                </div>
            ...
            <!-- Painel Operações -->
            <PainelOpsEnt v-if="etapa === 2" :e="entidade" :original="entidadeOriginal" :acao="acao" />
        </v-col>
    </v-row>
</v-container>
</template>
