...
<div>
    ...
    <v-card class="mt-4">
        <v-card-title class="info-label title" dark>Tabela de Seleção para a entidade {{ p.objeto.dados.ts.entidade }}</v-card-title>
        <v-card-text>
            <v-data-table :headers="tsHeaders" :items="p.objeto.dados.ts.listaProcessos.procs" class="elevation-1" :footer-props="tsFooterProps">
