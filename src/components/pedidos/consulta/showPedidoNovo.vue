...
<v-card class="ma-8">
    <div v-if="!erroDialog.visivel">
        ...
        <v-dialog v-model="distribuir" width="80%" persistent>
          ...
          }" :pedido="p.codigo" @fecharDialog="fecharDialog()" @avancarPedido="atribuirPedido($event)" />
        </v-dialog>
    </div>

    <!-- Campo despacho -->
    <v-dialog v-model="devolver" width="60%">
        <DevolverPedido @fecharDialog="fecharDialog()" @devolverPedido="despacharPedido($event)" />
    </v-dialog>
