    ...
    <div v-else>
        <v-card-text class="mt-2">
            <div v-if="!utilizadorSelecionado">
                ...
                <v-data-table :headers="usersHeaders" :items="utilizadores" :items-per-page="5" :search="procuraUtilizador" class="elevation-1">
            ...
            <div v-else>
                ...
                <v-row>
                    ...
                    <v-col>
                        <v-textarea solo hide-details color="indigo" :label="`Mensagem de despacho`" v-model="mensagemDespacho" />
                    </v-col>
                </v-row>
            </div>
        </v-card-text>
        ...
        <v-card-actions>
            ...
            <v-btn :disabled="utilizadorSelecionado === null" color="indigo accent-4 white--text" rounded @click="substituir()">
                Substituir
            </v-btn>
        </v-card-actions>
    </div>
