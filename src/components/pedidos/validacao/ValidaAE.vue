...
<div v-else>
    ...
    <v-row>
        <v-spacer />
        <PO operacao="Validar" @finalizarPedido="verificaCores($event)" @devolverPedido="despacharPedido($event)" />
    </v-row>
        ...
        <v-card>
            ...
            <v-card-text>
                <v-row>
                    ...
                    <v-col>
                        <v-textarea clearable filled auto-grow color="indigo" v-model="notaDialog.nota" label="Nota" />
                    </v-col>
                </v-row>
            </v-card-text>
        ...
        <v-card>
            <v-card>
                ...
                <v-card-text class="mt-4">
                    <v-row class="ma-2">
                        <v-text-field hint="Exemplo: 11.50" label="Insira a medição de UI" v-model="medicao" solo clearable />
                    </v-row>
                </v-card-text>
    ...
    <v-dialog v-model="colorDialog" width="700" persistent>
        <v-card outlined>
            <v-card-title class="orange darken-4 title white--text" dark>Campos por validar!</v-card-title>
            ...
            <v-card-actions>
                ...
                <v-btn color="indigo darken-4" text @click="
              colorDialog = false;
    ...
    <v-dialog v-model="sucessDialog" width="700" persistent>
        <v-card outlined>
            <v-card-title class="success darken-4 title white--text" dark>Auto de Eliminação adicionado com sucesso!</v-card-title>
