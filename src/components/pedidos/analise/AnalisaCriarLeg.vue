    ...
    >
      ...
      <template v-slot:item="props">
        <tr v-bind:style="props.item.style">
          ...
          <td
            class="subheading"
            v-if="props.item.conteudo.constructor === Array"
          >
            <ul>
          ...
          <td>
            <v-tooltip bottom>
              <template v-slot:activator="{ on }">
                <v-icon
                  v-on:click="props.item.style.backgroundColor = '#c8e6c9'"
            ...
            <v-tooltip bottom>
              <template v-slot:activator="{ on }">
                <v-icon
                  v-on:click="props.item.style.backgroundColor = '#ffcdd2'"
                  color="indigo darken-2"
                  v-on="on"
                  >clear</v-icon
                >
...
export default {
  ...
  mounted: function() {
    this.content.push({
      campo: "Tipo",
      conteudo: this.leg.dados.tipo,
      nota: "",
      style: { backgroundColor: "white" }
    });
    this.content.push({
      campo: "Número",
      conteudo: this.leg.dados.numero,
      nota: "",
      style: { backgroundColor: "white" }
    });
    this.content.push({
      campo: "Data",
      conteudo: this.leg.dados.data,
      nota: "",
      style: { backgroundColor: "white" }
    });
    this.content.push({
      campo: "Sumário",
      conteudo: this.leg.dados.sumario,
      nota: "",
      style: { backgroundColor: "white" }
    });
    this.content.push({
      campo: "Link",
      conteudo: this.leg.dados.link,
      nota: "",
      style: { backgroundColor: "white" }
    });
    this.content.push({
      campo: "Entidades responsáveis",
      conteudo: this.leg.dados.entidades,
      nota: "",
      style: { backgroundColor: "white" }
    });
    this.content.push({
      campo: "Processos regulados",
      conteudo: this.leg.dados.processos,
      nota: "",
      style: { backgroundColor: "white" }
    });
  }
