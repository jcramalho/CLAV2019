<template>
  <PainelCLAV titulo="Pedidos em Despacho" infoHeader="Pedidos em Despacho">
          ...
          <div class="info-content pa-4">
            ...
            >
              ...
              <template v-slot:[`item.tarefa`]="{ item }">
                ...
                >
                  <template v-slot:activator="{ on }">
                    <v-btn v-on="on" small text rounded @click="despacharPedido(item)">
                      <unicon
                        name="pedido-despacho-icon"
                        width="25"
                        height="25"
...
export default {
  ...
  methods: {
    ...
    despacharPedido(pedido) {
      ...
      this.$emit("despachar", pedidoProps);
    },
  },
};
</script>
