<template>
<div>
    <v-row v-if="!o.objeto.codigo == ''" class="align-center pa-3" style="text-align:center;">
        <!-- Guardar trabalho......................... -->
        <v-col>
            <v-btn @click="guardarTrabalho" rounded class="white--text" :class="{
        ...
        <!-- Criar classe......................... -->
        <v-col>
            <v-btn @click="criarClasse" color="success darken-1" rounded class="white--text" :class="{
            'px-8': $vuetify.breakpoint.lgAndUp,
            'px-2': $vuetify.breakpoint.mdAndDown
...
outline: none !important; width:100%;">
        ...
        <!-- Cancelar criação......................... -->
        <v-col>
            <v-btn @click="eliminarClasse" color="red darken-4" rounded class="white--text" :class="{
            'px-8': $vuetify.breakpoint.lgAndUp,
            'px-2': $vuetify.breakpoint.mdAndDown
          }" style="box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.4), 0 2px 4px -1px rgba(0, 0, 0, 0.36) !important;
outline: none !important; width:100%;">
    ...
    <v-row justify-center>
        <v-dialog v-model="pendenteGuardado" persistent max-width="60%">
            <v-card dark class="info-card">
                ...
                <v-card-actions>
                    <v-spacer></v-spacer>
                    <v-btn color="red darken-4" rounded dark elevation="0" class="px-4" @click="criacaoPendenteTerminada">
                        Fechar
                    </v-btn>
                </v-card-actions>
            </v-card>
        ...
        <v-dialog v-model="dialogClasseCriada" persistent max-width="60%">
            <v-card dark class="info-card">
              ...
              mensagemPedidoCriadoOK
                ...
                <v-card-actions>
                    <v-spacer></v-spacer>
                    <v-btn color="red darken-4" rounded dark elevation="0" class="px-4" @click="criacaoClasseTerminada">
                        Fechar
                    </v-btn>
                </v-card-actions>
            </v-card>
    ...
    <v-row justify-center>
        <v-dialog v-model="pedidoEliminado" persistent max-width="60%">
            <v-card dark class="info-card">
                ...
                <v-card-actions>
                    <v-spacer></v-spacer>
                    <v-btn color="success darken-1" rounded dark elevation="0" class="px-4" @click="cancelarCriacaoClasse">
                        Confirmo
                    </v-btn>
