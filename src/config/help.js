module.exports.help = {
    ListaConsolidada: "Estrutura hierárquica de classes que representam as funções (classes de 1º nível)," +
    ...
    TabelasSelecao: "Tabelas de seleção submetidas pelas entidades e aprovadas pela Direção-Geral do Livro, " +
    ...
    Classe: {
        BlocoDescritivo: "Conjunto de campos que descrevem a classe. Aplica-se às classes de 1º, 2º, 3º e 4º nível.",
        BlocoContexto: "Conjunto de campos com informação sobre os intervenientes, os PN relacionados e legislação" +
                        " e que tem por objetivo enquadrar as decisões de avaliação. Aplica-se às classes de 3º nível.",
        BlocoDecisoes: "Conjunto de campos que contem as decisões de avaliação, isto é, o prazo de conservação " +
        ...
        Campos: {
            Estado: "Indicação do estado de atividade da classe:  ativo ou inativo.  Aplica-se às classes de 1º, 2º, 3º e 4º nível.",
            Pai: "Classe que se encontra imediatamente acima,  com indicação do respetivo código e  título. Aplica-se às classes de 2º, 3º e 4º nível.",
            Descendencia: "Classe que se encontra imediatamente abaixo,  com indicação do respetivo código e título. Aplica-se às classes de 1º, 2º e 3º nível.",
            Codigo: "Sistema numérico que identifica univocamente a classe. Aplica-se às classes de 1º, 2º, 3º e 4º nível.",
            Titulo: "Designação da classe. Aplica-se às classes de 1º, 2º, 3º e 4º nível.",
            Descricao: "Informação descritiva do âmbito da classe. Aplica-se às classes de 1º, 2º, 3º e 4º nível.",
            NotasAp: "Informação que especifica o âmbito de aplicação da classe. Aplica-se às classes de 1º, 2º e 3º nível.",
            ExemplosNotasAp: "Informação que exemplifica o âmbito de aplicação da classe. Aplica-se às classes de 1º, 2º e 3º  nível.",
            NotasEx: "Informação remissiva para outras classes com conteúdos similares ou sequenciais, auxilia a delimitar a aplicação da classe. Aplica-se às classes de 1º, 2º e 3º nível.",
            TermosIndice: "Termos que detalham o âmbito de aplicação dos processos de negócio e apoiam a recuperação da informação. Aplica-se às classes de 3º ou 4º nível.",
            ...
            FormaContagem: "<p>Instrução relativa à ação / momento que origina a contagem do prazo. Aplica-se às classes de 3º " +
                            "ou 4º nível.</p>" + 
    ...
    Entidade: {
        Campos: {
            ...
            Estado: "Indicação do estado da entidade: em atividade (ativa) ou extinta (inativa).",
        ...
        Intervencoes: {
            ...
            Participante: "<p>Processos de negócio em que a entidade intervém como participante e respetivo tipo de " +
                        "participação.</p>" +
        ...
        Relacoes: {
            ...
            IntegraCompetenciasDe: "Designação da(s) entidade(s) antecessora(s) de que provêm as competências integradas.",
            CompetenciasIntegradasEm: "Designação da(s) entidade(s) sucessora(s) que integrou(ram) competências da entidade referida."
        }
    },
    Tipologias: {
        Campos: {
        ...
        Intervencoes: {
            Dono: "Processos de negócio em que a tipologia de entidade intervém como dono.",
            Participante: "<p>Processos de negócio em que a tipologia de entidade intervém como participante e respetivo tipo " +
                        "de participação.</p>\n" +
    ...
    Legislacao: {
        Campos: {
            ...
            Sumario: "Sumário do diploma.",
            ProcessosRegulados: "Processos de negócio que são regulados ou enquadrados pelo diploma."
        },
        Relacoes: {
            Altera: "Referência ao(s) diploma(s) que altera.",
            Revoga: "Referência ao(s) diploma(s) que revoga.",
            AlteradoPor: "Referência ao(s) diploma(s )que altera(m) o diploma referenciado.",
            RevogadoPor: "Referência ao(s) diploma(s) que altera(m) o diploma referenciado."
        }
    }
}   
