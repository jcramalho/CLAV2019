...
export const classeCriacaoProcessosRelacionadosOps = {
  remover: "Remover"
};

export const criterios = {
  textoCriterioJustificacaoGestionario:
    "Prazo para imputação de responsabilidade pela gestão estratégica, decorrente de escrutínio público" +
